...
pub use engine::{
  ...
  pull_profile_after_remote_session, request_profile_sync, resume_profile_sync,
  ...
  set_proxy_sync_enabled, set_vpn_sync_enabled, sync_profile, trigger_sync_for_profile,
  ProfileSyncOutcome, SyncEngine,
};
pub use manifest::{
